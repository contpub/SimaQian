...
<g:if test="${category=='support'&&name=='iphone'}">
	...
	<p>親愛的使用者您好，我們是 CafeBook 的服務團對，如您有任何疑問、想法、建議或問題回報，請利用本頁下方的表單告訴我們，您也可以來信 <img src="http://services.nexodyne.com/email/icon/k5MvSBNECg%3D%3D/yE0xeUo%3D/R01haWw%3D/0/image.png" alt="E-Mail" /> 與我們聯絡。</p>

	<p>CafeBook 是國內首創結合雲端製作電子書的網路書城，您不僅可以一邊喝咖啡一邊閱讀電子書，且只要煮一杯咖啡的時間，您也可以自己出版一本電子書！</p>

	<p>再次歡迎您使用 CafeBook，謝謝您！</p>
 
	<p>We're support team of CafeBook. Any questions, ideas, suggestions and bug reports,
please tell us with questionnaire below. Also you could send a mail to <img src="http://services.nexodyne.com/email/icon/k5MvSBNECg%3D%3D/yE0xeUo%3D/R01haWw%3D/0/image.png" alt="E-Mail" />.
	...
	<p>Welcome to use CafeBook. Thanks.</p>
